...
create table locationSitze(LfdNr integer primary key, locationID integer, kategorie varchar, sitznummer integer, foreign key (locationID) references location(locationID));
insert into locationSitze(locationID, kategorie, sitznummer) values (1, 'Liegeplatz', 1), (2, 'Liegeplatz', 2), (3, 'Sitzplatz', 3), (4, 'Sitzplatz', 4), (5, 'Stehplatz', 5), (6, 'Stehplatz', 6), (7, 'Stehplatz', 7);

create table belegung(belegungID integer primary key, location_sitze_LfdNr integer, veranstaltungsID integer, foreign key (location_sitze_LfdNr) references locationSitze(LfdNr), foreign key (veranstaltungsID) references veranstaltung(veranstaltungsID));
